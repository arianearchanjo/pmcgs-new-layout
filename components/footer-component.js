          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
              ...
              <ul>
                ...
                <li><a href="https://campinagrandedosul.pr.gov.br/emissao-da-certidao-de-debitos">Certidão de Débitos</a></li>
                <li><a href="https://campinagrandedosul.pr.gov.br/emissao-da-nota-fiscal-de-servicos">Nota Fiscal de Serviços</a></li>
                <li><a href="https://campinagrandedosul.pr.gov.br/consulta-de-processos">Consulta de Processos</a></li>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
              ...
              <h6 class="mt-3">TRANSPARÊNCIA</h6>
              <ul>
                <li><a href="https://campinagrandedosul.pr.gov.br/transparencia">Portal da Transparência</a></li>
                <li><a href="https://radardatransparencia.atricon.org.br/">Radar da Transparência</a></li>
                <li><a href="https://campinagrandedosul.pr.gov.br/acesso-a-informacao">Acesso à Informação</a></li>
                <li><a href="https://campinagrandedosul.pr.gov.br/consulta-legislacao-municipal">Legislação Municipal</a></li>
                <li><a href="https://campinagrandedosul.oxy.elotech.com.br/portaltransparencia/1/">PPA / LDO / LOA</a></li>
                <li><a href="https://campinagrandedosul.oxy.elotech.com.br/portaltransparencia/1/obraspublicas">Obras Públicas</a></li>
              </ul>
            </div>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
              ...
              <address class="footer-contact" style="font-style:normal;">
                <p><i class="fas fa-map-marker-alt"></i>Praça Bento Munhoz, 30 – Centro<br>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Campina Grande do Sul – PR</p>
                <p><i class="fas fa-phone"></i>(41) 3162-7000</p>
                <p><i class="fas fa-envelope"></i><a href="mailto:faleconosco@pmcgs.pr.gov.br" style="color:rgba(255,255,255,.6);">faleconosco@pmcgs.pr.gov.br</a></p>
                <p><i class="fas fa-clock"></i>Seg. a Sex. – 8h30–12h / 13h30–17h30</p>
              </address>
              <h6 class="mt-3">REDES SOCIAIS</h6>
              <div style="display:flex;gap:10px;flex-wrap:wrap;" aria-label="Redes sociais da Prefeitura">
                <a href="https://www.facebook.com/PrefDeCampina" target="_blank" rel="noopener" style="color:rgba(255,255,255,.6);font-size:20px;"><i class="fab fa-facebook-f"></i></a>
                <a href="https://www.instagram.com/prefdecampina" target="_blank" rel="noopener" style="color:rgba(255,255,255,.6);font-size:20px;"><i class="fab fa-instagram"></i></a>
                <a href="https://www.youtube.com/@prefdecampina" target="_blank" rel="noopener" style="color:rgba(255,255,255,.6);font-size:20px;"><i class="fab fa-youtube"></i></a>
                <a href="https://campinagrandedosul.pr.gov.br/whatsapp" target="_blank" rel="noopener" style="color:rgba(255,255,255,.6);font-size:20px;"><i class="fab fa-whatsapp"></i></a>
              </div>
            </div>
          </div>
